...
function cleanText(text: string): string {
  ...
  // 4. Видаляємо списки розділів/навігації сайту (наприклад: "5.8: Тектонічні плити Землі 5.10: Теорія тектоніки плит"), які йдуть підряд в один рядок
  cleaned = cleaned.replace(/\b\d+\.\d+:\s*[A-Za-zА-Яа-яЁёЇїІіЄєҐґ\w\-’'`’\" ]{3,100}(?=\s+\d+\.\d+:)/g, '')
